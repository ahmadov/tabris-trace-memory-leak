# Tabris Trace Memory Leak example

[![Open in Gitpod](https://gitpod.io/button/open-in-gitpod.svg)](https://gitpod.io/#https://github.com/ahmadov/tabris-trace-memory-leak)

An example Tabris.js app demonstrating how to trace memory consumption and find potentional memory leaks using ([Chrome DevTools](https://developers.google.com/web/tools/chrome-devtools)).
